...
class AccountController extends Controller
{
    ...
    // This method will save job in the database 
    ...
    // This method will update job in the database 
    ...
    // This method will show the saved jobs 
    ...
    public function removeSavedJob(Request $request)
    {
        ...
        if ($savedJob == null) {
            $savedJob = session()->flash('error', 'Job not found');
            return response()->json([
                'status' => false,
            ]);
        }
        ...
        $jobApplication = session()->flash('success', 'Job removed successfully.');
        return response()->json([
            'status' => true,
        ]);
    }

    // This method will update the password of the current user 
    ...
    public function processForgotPassword(Request $request)
    {
        ...
        return redirect()->route('account.forgotPassword')->with('success', 'A password reset link has been sent to your email');
    }
